...
const SectionSkeleton = ({ height = "h-64" }) => (
  <div className={`w-full ${height} bg-gray-200 dark:bg-slate-800 animate-pulse rounded-lg flex items-center justify-center`}>
    <span className="text-gray-400 dark:text-slate-300 text-sm">Loading...</span>
  </div>
);
...
const CardGridSkeleton = () => (
  <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-5 md:gap-6 mt-5">
    {[...Array(10)].map((_, i) => (
      <div key={i} className="h-80 bg-gray-200 animate-pulse dark:bg-slate-800 rounded-lg"></div>
    ))}
  </div>
);
  ...
  return (
    <main className="md:pt-32 pt-24 xl:px-20 lg:px-20 px-4 min-h-screen pb-10">
      ...
      <section className="min-h-80 mb-5 sm:mb-8"> 
        <h1 className="uppercase font-bold text-2xl dark:text-gray-200 text-blue-400 my-3">Featured Books</h1>
      ...
      <section className="mb-5 sm:mb-8 min-h-[250px]">
        <div className="flex justify-between items-center text-blue-400 mb-4">
          <h1 className="uppercase font-bold text-2xl text-blue-400 dark:text-gray-200">Classic</h1>
      ...
      <section className="mb-5 sm:mb-8 min-h-[250px]">
        <div className="flex justify-between items-center text-blue-400 mb-4">
          <h1 className="uppercase font-bold text-2xl text-blue-400 dark:text-gray-200">Classic Romance</h1>
      ...
      <section id="books-grid">
        <h1 className="uppercase font-bold text-2xl text-blue-400 dark:text-gray-200">All Books</h1>
        ...
        <div className="flex relative flex-col sm:flex-row justify-between items-center py-5 gap-4 mt-5">
          <Pagination type="homepage" page={page} totalPages={totalPages} onPrev={handlePrev} onNext={handleNext}/>
        </div>
          </>
        )}
      </section>
